...
function bones_custom_admin_footer() {
	_e( '<span id="footer-thankyou">Developed by Joshua Iz for <a href="http://wearebio.com" target="_blank">BioDesign</a></span>. Built using <a href="http://themble.com/bones" target="_blank">Bones</a>.', 'bonestheme' );
}
...
function custom_admin_styles() {
  echo '<style>
    #menu-posts-promos, .menu-icon-promos, .menu-icon-promos div.wp-menu-image:before {
