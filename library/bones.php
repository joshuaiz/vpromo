...
wp_enqueue_style('qtip', '/js/jquery.qtip.min.css', null, false, false);

// wp_enqueue_style('jquery-ui-styles', '/js/jquery-ui.min.css', null, false, false);
...
wp_enqueue_script('qtip', '/js/jquery.qtip.custom.min.js', array('jquery'), false, true);
